...
def kernel(args, x, y, kernel_type="poly"):
...
def smo(args, train_data, train_target, test_data, test_target):
    ...
    train_kernel = kernel(args, train_data, train_data, kernel_type=args.kernel)
    test_kernel = kernel(args, test_data, train_data, kernel_type=args.kernel)
    tol = args.tolerance
    C = args.C
